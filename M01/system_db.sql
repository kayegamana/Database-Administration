...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2024 at 03:34 PM
...
(7, 1, 'Missing my amazing friends today! The laughter, the inside jokes, and all the little moments we share. Can\'t wait to make more memories together soon pls pls plssssss!!!!', '10:21 pm 26/10/2024', 'Friends', 'No', '', 2, 2),
...
(36, 1, 'That may be all I need, In darkness, she is all I see (all I see)! Come and rest your bones with me! Driving slow on Sunday morning, and I never want to leave', '10:32 pm 2024-11-10', 'Public', 'no', '', 1, 1),
(37, 1, 'From following your footprints in the sand, To walking with you on this island', '10:33 pm 2024-11-10', 'Friends', 'no', '', 1, 1);
...
--
ALTER TABLE `posts`
  MODIFY `postID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
