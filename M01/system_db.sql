...
(27, 1, 'Sa unang tingin, agad na nahumaling. Sa nagniningning mong mga mata', '20:38 2024-11-10', 'Public', 'no', '', 1, 1),
(28, 1, 'Liwanag na dulot mo, nagbigay-sinag sa madilim kong mundo', '20:40 2024-11-10', 'Friends', 'no', '', 1, 1),
(29, 1, 'That may be all I need, In darkness, she is all I see (all I see)! Come and rest your bones with me! Driving slow on Sunday morning, and I never want to leave', '21:06 2024-11-10', 'Public', 'no', '', 1, 1);
...
--
ALTER TABLE `posts`
  MODIFY `postID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
